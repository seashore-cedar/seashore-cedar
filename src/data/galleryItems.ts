...
export const galleryItems: GalleryItem[] = [
  ...
  { id: 'gallery-4', slot: '/assets/BB-16Inch.png', alt: '16" cement beach ball', category: 'Cement Beach Balls', caption: '16" cement beach ball', visible: true },
  { id: 'gallery-5', slot: '/assets/customengraved2.png', alt: 'Custom cedar engraving', category: 'Cedar Cutouts', caption: 'Custom cedar engraving', visible: true },
  { id: 'gallery-6', slot: '/assets/customengraved.png', alt: 'Personalized engraved cutting board', category: 'Cedar Cutouts', caption: 'Personalized engraved cutting board', visible: true },
  ...
  { id: 'gallery-9', slot: '/assets/Glued_Joints.png', alt: 'Handcrafted cedar joinery', category: 'Details', caption: 'Handcrafted cedar joinery', visible: true },
