  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5">
        <h3 className="font-heading text-lg text-foreground mb-3" style={{ letterSpacing: '-0.01em' }}>
          {product.name}
        </h3>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            <motion.p variants={fadeUp} className="text-white/70 text-sm md:text-base">
              Discounted items, seconds &amp; one-of-a-kind pieces — while they last
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24" style={{ background: 'hsl(var(--background))' }}>
        <div className="container mx-auto px-6">
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Free local pickup · Wildwood, NJ · Local delivery Mon–Thu to select areas
          </p>
        </div>
      </section>
    </>
